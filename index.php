...
<body class="bg-white">
    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
         ...
         <div class="d-flex">
            <!----Login Button---->
            <a href="login2.php"><button type="button" class="btn btn-outline-dark shadow-none me-lg-2 me-2" data-bs-toggle="modal" data-bs-target="#loginModal">
             Login
            </button></a>
            <a href="register.php"><button type="button" class="btn btn-outline-dark shadow-none" data-bs-toggle="modal" data-bs-target="#registerModal">
             Register
            </button></a>
            <!---end login button--->
        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <a href="login2.php"class="btn btn-sm text-white custom-bg shadow-none">Book now!</a>
